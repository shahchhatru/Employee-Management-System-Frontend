        ...
        try {
            ...
            if (password === confirmPassword) {
                if (email !== "" && password.length >= 8) {
                    response = await dispatch(signup({ name: username, email, password })).unwrap();
    ...
    return (
        ...
        >
            ...
            < div className="p-4 w-full grid grid-cols-12" >
                <div className="col-start-1 col-end-5 flex items-center space-x-2" > </div>
            ...
            < div className="w-full p-4" >
                <Button
                    className="bg-custom-reddanger rounded-full w-full mb-4 hover:bg-custom-stonewhite hover:text-black text-card-foreground"
